...
function page() {
  return (
    ...
    <div className='w-[100vw] min-h-[140vh] text-white bg-[#000000f2]  overflow-x-hidden relative'>
       <img src="https://nextui.org/gradients/docs-right.png"  alt="" className=' md:w-[70vw] w-[100vw] absolute md:-right-[30%] md:-top-[30%] top-[10%] left-[30%]'/>
        <img src="https://nextui.org/gradients/docs-left.png" className=' md:w-[70vw] absolute md:-left-[25%] top-[40%] -left-[10%] ' alt="" />
